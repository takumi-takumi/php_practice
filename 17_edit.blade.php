            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" value="{{ $profiles_form->name }}" style="width:200px">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <ul class="list-group">
                            @if ($profiles_form->profilehistories != NULL)
                                @foreach ($profiles_form->profilehistories as $profilehistory)
                                    <li class="list-group-item" style="width:180px">{{ $profilehistory->edited_at }}</li>
                                @endforeach
                            @endif
                        </ul>
                    </div>
